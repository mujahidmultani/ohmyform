...
angular.module('forms').config(['$translateProvider', function ($translateProvider) {
  	...
  	$translateProvider.translations('fr', {
		...
		COPIED_LABEL: 'Copié',
		COPY: "Copier",
		COPY_AND_PASTE: "Copiez et collez ceci pour ajouter votre MySurvey à votre site Web",
		CHANGE_WIDTH_AND_HEIGHT: "Changez les valeurs de largeur et de hauteur pour mieux vous convenir",
		POWERED_BY: "Alimenté par",
		OHMYFORM_URL: "Votre MySurvey est disponible à cette URL",
		...
		EDIT_FORM: "Modifier ce MySurvey",
