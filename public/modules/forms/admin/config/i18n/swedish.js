...
angular.module('forms').config(['$translateProvider', function ($translateProvider) {
	...
	$translateProvider.translations('sv', {
		...
		PREVIEW: 'Förhandsvy',
		COPY: 'Kopiera',
		COPY_AND_PASTE: 'Kopiera och Klistra in detta för att lägga till din MySurvey till din hemsida.',
		CHANGE_WIDTH_AND_HEIGHT: 'Ändra bredd- och höjdvärden för att det ska passa dig bäst',
		POWERED_BY: 'Genererad av',
		OHMYFORM_URL: "Din MySurvey är permanent på denna URL",
		...
		EDIT_FORM: 'Redigera denna MySurvey',
