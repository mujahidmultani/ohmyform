...
module.exports = {
		...
		questionsPart1: [
			{
				type: 'list',
				name: 'NODE_ENV',
				message: 'What mode do you want to run MySurvey in?',
			...
			},
			{
				type: 'input',
				name: 'APP_NAME',
				message: 'What do you want to name your MySurvey deployment?'
			},
			{
				type: 'input',
				name: 'APP_DESC',
		...
		questionsPart2: [
			...
			},
			{
				type: 'input',
				name: 'BASE_URL',
				message: 'What is the (root) url your MySurvey will be hosted at?',
				default: 'localhost'
			},
			{
				type: 'input',
				name: 'PORT',
				message: 'What port should the MySurvey server run on?',
				default: '3000'
			},
			{
				type: 'input',
