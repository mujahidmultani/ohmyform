...
var exitSuccess = function(cb) {
	console.log(chalk.green('MySurvey has been successfully setup'));
	console.log(chalk.green('Have fun using MySurvey!'));
...
var checkENVAndRunSetup = function(cb) {
	...
	if(require.main === module){
		console.log(chalk.green('Welcome to MySurvey\'s Setup Tool'));
	...
	if(fs.existsSync('./\.env') && require.main === module) {
		...
		if(require.main !== module){
			console.log(chalk.green('Welcome to MySurvey\'s Initial Setup\n'));
			console.log(chalk.green('The following prompts will help you properly configure your MySurvey instance.'));
